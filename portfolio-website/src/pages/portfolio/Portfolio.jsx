    ...
    <>
        <div className="portfolio-container">
            <div className="portfolio-heading">
                <h2>My Projects</h2>
                <button onClick={openSite}><img src={github} alt="github-image" /> Visit my Github</button>
            </div>
            <div className="projects">
                {information.map(project => {
                    return <ProjectCard key={project.key} name={project.name} id={project.id} detail={project.details} image={project.image} githubButton={project.github} vercelButton={project.vercel}/>
                })}
            </div>
        </div>
    </>
